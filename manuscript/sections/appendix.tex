...
Table~\ref{tab:city_split_gap_summary} gives the corresponding Austin and Seattle split-level paired gaps. With only two split pairs per city, these numbers should be read as descriptive evidence about directional consistency rather than as precise interval estimates.
