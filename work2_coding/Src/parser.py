...
class Parser(object):
    ...
    def environment_parameters(self, parser):
        ...
        parser.add_argument("--min_price", default=-6.0, help="max discount <0", type=float)

        parser.add_argument("--k", default=8, help="Number of parcelpoints to offer to customer", type=int)

        parser.add_argument("--n_vehicles", default=15, help="number of vehicles", type=int)#Austin=20, Seattle=25
        parser.add_argument("--veh_capacity", default=25, help="capacity per vehicle per day", type=int)
        ...
        parser.add_argument("--incentive_sens", default=-0.25, help="sensitivty of customer to incentives", type=float)#-0.25
