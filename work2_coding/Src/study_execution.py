        ...
        rows.append(
            build_normalized_row(
                ...
                menu_metadata={
                    ...
                    "method_family": setting["args"].get("method_family"),
                    "outside_option_util": setting["args"].get("outside_option_util", 0.0),
                },
...
def _row_from_actual_replay(setting, run_id):
    ...
    menu_metadata = {
        ...
        "method_family": last_policy_diagnostic.get("method_family", args.get("method_family", "DSPO")),
        "outside_option_util": args.get("outside_option_util", 0.0),
...
def failed_row_for_setting(setting, run_id, exc, manifest=None, root=None):
    ...
    return build_normalized_row(
        ...
        menu_metadata={
            ...
            "method_family": args.get("method_family", "DSPO"),
            "outside_option_util": args.get("outside_option_util", 0.0),
            "error_type": error_type,
            "error_message": str(exc),
        },
